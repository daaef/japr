...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "admin_audit_logs_user_idx" ON "admin_audit_logs" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "admin_audit_logs_action_idx" ON "admin_audit_logs" USING btree ("action");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "admin_audit_logs_resource_idx" ON "admin_audit_logs" USING btree ("resource_type","resource_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "admin_audit_logs_risk_idx" ON "admin_audit_logs" USING btree ("risk_level");
--> statement-breakpoint
